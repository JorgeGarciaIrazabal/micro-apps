...
const EGGS = [
  {
    ...
    clue: 'Go to Mom and Dad\'s room. Find the big dark basket where dirty clothes go. Look inside!',
  ...
  },
  {
    ...
    room: 'pbed',
    roomLabel: 'Mom & Dad\'s Room',
    clue: 'Stay in Mom and Dad\'s room. Find the little wooden chair under the makeup table. Look under it!',
    icons: ['chair','table'],
    passcode: ['🌈','🦋','🐣'],
  ...
  },
  {
    ...
    clue: 'Walk into the big closet. Look at the bottom shelf. It sits on top of folded clothes!',
    icons: ['shelf','clothes'],
    passcode: ['🌷','🍫','⭐'],
  ...
  },
  {
    ...
    clue: 'Go to your room! Find your blue globe on the white desk. Look behind it!',
    icons: ['globe','desk'],
    passcode: ['🎀','🐝','🌻'],
  ...
  },
  {
    ...
    room: 'cbed',
    roomLabel: 'Clara\'s Room',
    clue: 'Stay in your room. Find the little grey couch by the glass door. Check the cushions!',
    icons: ['couch','door'],
    passcode: ['🍓','🦄','💜'],
  ...
  },
  {
    ...
    clue: 'Go to your bathroom. Find the pretty unicorn picture on the wall. Look right under it!',
    icons: ['unicorn','wall'],
    passcode: ['🐞','🎈','🌺'],
  ...
  },
  {
    ...
    room: 'hall',
    roomLabel: 'Hallway',
    clue: 'Walk to the hallway. Find the black sports bag hanging up. Check the side pocket!',
    icons: ['bag','pocket'],
    passcode: ['🐰','🌸','⭐'],
  ...
  },
  {
    ...
    clue: 'Go to the living room. Find the big piano. The egg is sitting right on the keys!',
    icons: ['piano','music'],
    passcode: ['🦋','🍫','🎀'],
  ...
  },
  {
    ...
    room: 'living',
    roomLabel: 'Living Room',
    clue: 'Stay in the living room. Find the tall green plant by the TV. Look behind it!',
    icons: ['plant','tv'],
    passcode: ['🌈','🐣','🌻'],
  ...
  },
  {
    ...
    room: 'kitchen',
    roomLabel: 'Kitchen',
    clue: 'Go to the kitchen. Find the little pink step stool near the trash can. Look under it!',
    icons: ['step','trash'],
    passcode: ['🌷','🦄','🐞'],
  ...
  },
  {
    ...
    clue: 'Open the pantry door! Look at the very bottom shelf. The egg is hiding down low!',
    icons: ['door','shelf'],
    passcode: ['🥕','💜','🎈'],
  ...
  },
  {
    ...
    room: 'office',
    roomLabel: 'Sunroom',
    clue: 'Go to the sunroom where Pokey hangs out. Find the cat tree. Look in the little bottom hole!',
    icons: ['cat','tree'],
    passcode: ['🐰','🍓','🌺'],
