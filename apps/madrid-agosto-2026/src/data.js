  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '🏰', kind: { en: 'Optional', es: 'Opcional' }, title: { en: 'Villarejo de Salvanés — castle keep', es: 'Villarejo de Salvanés — torre del homenaje' }, place: { en: 'Madrid', es: 'Madrid' }, drive: '20–25 min',
        ...
        tags: ['town', 'kids', 'culture'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/villarejo-de-salvanes-madrid/' }, { label: { en: 'Houses nearby · 3bed', es: 'Casas cerca · 3 dorm' }, type: 'web', url: 'https://www.idealista.com/venta-viviendas/valdaracete-madrid/con-precio-hasta_300000,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas,dos-banos,tres-banos-o-mas,sin-inquilinos,nuda-propiedad,inquilino/' }, { label: { en: 'Tourism', es: 'Turismo' }, type: 'web', url: 'https://www.turismovillarejodesalvanes.com/index.php' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Castillo Villarejo de Salvanes') }] },
    ],
  },
  {
  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '📍', kind: { en: 'Town scouting', es: 'Ver pueblo' }, title: { en: 'Galápagos / Montelar', es: 'Galápagos / Montelar' }, place: { en: 'Guadalajara', es: 'Guadalajara' }, drive: '30–40 min',
        ...
        links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/galapagos-guadalajara/' }, { label: { en: 'Houses · 3bed · <300k', es: 'Casas · 3 dorm · <300k' }, type: 'web', url: 'https://www.idealista.com/venta-viviendas/galapagos-guadalajara/con-precio-hasta_300000,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas,dos-banos,tres-banos-o-mas,sin-inquilinos,nuda-propiedad,inquilino/' }, { label: { en: 'Town info', es: 'Info pueblo' }, type: 'web', url: 'https://www.galapagos.es/' }, { label: { en: 'Pumptrack', es: 'Pumptrack' }, type: 'map', url: maps('Pumptrack Park Montelar Galapagos') }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Montelar Galapagos Guadalajara') }] },
      { icon: '🏢', kind: { en: 'Condo scouting', es: 'Ver pisos' }, title: { en: 'Valdeluz', es: 'Valdeluz' }, place: { en: ' Guadalajara', es: ' Guadalajara' }, drive: '15 min toward Madrid',
        ...
        tags: ['town'], links: [{ label: { en: 'Idealista · condos', es: 'Idealista · pisos' }, type: 'web', url: 'https://www.idealista.com/geo/venta-viviendas/valdeluz/' }, { label: { en: 'Apts · 3bed · <300k', es: 'Pisos · 3 dorm · <300k' }, type: 'web', url: 'https://www.idealista.com/geo/venta-viviendas/valdeluz/con-precio-hasta_300000,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas,dos-banos,tres-banos-o-mas,sin-inquilinos,nuda-propiedad,inquilino/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Valdeluz 19139 Guadalajara Spain') }] },
  ...
  },
  {
    ...
    stops: [
      { icon: '📍', kind: { en: 'Town (quick)', es: 'Pueblo (rápido)' }, title: { en: 'El Espinar / Los Ángeles de San Rafael', es: 'El Espinar / Los Ángeles de San Rafael' }, place: { en: 'Segovia', es: 'Segovia' }, drive: '45–55 min',
        ...
        tags: ['town'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/el-espinar-segovia/' }, { label: { en: 'Houses · 3bed · <300k', es: 'Casas · 3 dorm · <300k' }, type: 'web', url: 'https://www.idealista.com/venta-viviendas/el-espinar-segovia/con-precio-hasta_300000,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas,dos-banos,tres-banos-o-mas,sin-inquilinos,nuda-propiedad,inquilino/' }, { label: { en: 'Town info', es: 'Info pueblo' }, type: 'web', url: 'https://elespinar.es/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Los Angeles de San Rafael El Espinar Segovia') }] },
  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '📍', kind: { en: 'Retirement scouting', es: 'Ver pueblo' }, title: { en: 'Sotillo de la Adrada (Valle del Tiétar)', es: 'Sotillo de la Adrada (Valle del Tiétar)' }, place: { en: 'Ávila (N-403 / A-5)', es: 'Ávila (N-403 / A-5)' }, drive: '45 min S',
        ...
        tags: ['town', 'nature'], links: [{ label: { en: 'Idealista · homes', es: 'Idealista · casas' }, type: 'web', url: 'https://www.idealista.com/venta-viviendas/sotillo-de-la-adrada-avila/' }, { label: { en: 'Houses · 3bed · <300k', es: 'Casas · 3 dorm · <300k' }, type: 'web', url: 'https://www.idealista.com/venta-viviendas/sotillo-de-la-adrada-avila/con-precio-hasta_300000,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas,dos-banos,tres-banos-o-mas,sin-inquilinos,nuda-propiedad,inquilino/' }, { label: { en: 'Inmobiliaria', es: 'Inmobiliaria' }, type: 'web', url: 'https://grupoexcon.com/inmobiliaria/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Sotillo de la Adrada Avila') }] },
    ],
  },
  {
  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '📍', kind: { en: 'On the way home', es: 'De vuelta a casa' }, title: { en: 'Villacastín (drive-through)', es: 'Villacastín (de paso)' }, place: { en: 'Segovia (A-6)', es: 'Segovia (A-6)' }, drive: '+15 min',
        ...
        tags: ['town'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/villacastin-segovia/' }, { label: { en: 'Houses · 3bed · <300k', es: 'Casas · 3 dorm · <300k' }, type: 'web', url: 'https://www.idealista.com/venta-viviendas/villacastin-segovia/con-precio-hasta_300000,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas,dos-banos,tres-banos-o-mas,sin-inquilinos,nuda-propiedad,inquilino/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Villacastin Segovia') }] },
