  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '📍', kind: { en: 'On the way home', es: 'De vuelta a casa' }, title: { en: 'Villacastín (drive-through)', es: 'Villacastín (de paso)' }, place: { en: 'Segovia (A-6)', es: 'Segovia (A-6)' }, drive: '+15 min',
        ...
        tags: ['town'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/villacastin-segovia/' }, { label: { en: '🏠 €160k · 146m² · 4bed (Maello)', es: '🏠 160k€ · 146m² · 4 dorm (Maello)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/4-hab-maello-avila/5402066' }, { label: { en: '🏠 €187k · 214m² · 3bed (Zarzuela)', es: '🏠 187k€ · 214m² · 3 dorm (Zarzuela)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-zarzuela-del-monte-segovia/5372017' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Villacastin Segovia') }] },
