...
export const days = [
  ...
  },
  {
    ...
    title: { en: 'EAST — Parque Europa + Alcalá + Guadalajara towns', es: 'ESTE — Parque Europa + Alcalá + pueblos de Guadalajara' },
    corridor: { en: 'East (A-2 / A-3)', es: 'Este (A-2 / A-3)' },
    heat: null, tags: ['town', 'culture', 'kids', 'seniors', 'food', 'booking'],
    summary: {
      en: 'A playful mini-tour of Europe before the heat, then UNESCO Alcalá de Henares for lunch, and two quick reference stops in Guadalajara (Azuqueca and Villanueva de la Torre).',
      es: 'Una mini-vuelta por Europa antes del calor, luego Alcalá de Henares (Patrimonio) para comer, y dos paradas de referencia rápida en Guadalajara (Azuqueca y Villanueva de la Torre).' },
    stops: [
      ...
      { icon: '📍', kind: { en: 'Town scouting · not recommended', es: 'Ver pueblo · no recomendado' }, title: { en: 'Azuqueca de Henares', es: 'Azuqueca de Henares' }, place: { en: 'Guadalajara · ~15 min from Alcalá', es: 'Guadalajara · ~15 min de Alcalá' }, drive: '~15 min',
        desc: { en: 'Visited but did not win the family over. Explored and left as a reference / crossed off for future visits.', es: 'Visitada pero no convenció a la familia. Se exploró y se deja como referencia / descartada para futuras visitas.' },
        tags: ['town'], links: [{ label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Azuqueca de Henares Guadalajara') }] },
      { icon: '📍', kind: { en: 'Town scouting · 4/10', es: 'Ver pueblo · 4/10' }, title: { en: 'Villanueva de la Torre', es: 'Villanueva de la Torre' }, place: { en: 'Guadalajara · ~15 min from Azuqueca', es: 'Guadalajara · ~15 min de Azuqueca' },
        desc: { en: 'Visited — family rating 4/10 (fair/average). A quick reference stop on the way back.', es: 'Visitada — valoración familiar 4/10 (regular). Una parada de referencia rápida de camino.' },
        tags: ['town'], links: [{ label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Villanueva de la Torre Guadalajara') }] },

    ],
  },
  {
    id: 'aug05', dow: { en: 'Wed', es: 'Mié' }, label: 'Aug 5', emoji: '👵',
    title: { en: 'NORTH — morning scouting + evening with grandma', es: 'NORTE — scouting por la mañana + noche con la abuela' },
    corridor: { en: 'North (A-1)', es: 'Norte (A-1)' },
    heat: null, tags: ['town', 'kids', 'food', 'booking', 'seniors', 'friends'],
    summary: {
      en: 'Scout Galápagos / Montelar and Valdeluz in the morning, then finish the day with grandma in Torremocha del Jarama — last stop before heading home.',
      es: 'Scouting a Galápagos / Montelar y Valdeluz por la mañana, y acabar el día con la abuela en Torremocha del Jarama — última parada antes de volver a casa.' },
    stops: [
      { icon: '📍', kind: { en: 'Town scouting · morning', es: 'Ver pueblo · mañana' }, title: { en: 'Galápagos / Montelar', es: 'Galápagos / Montelar' }, place: { en: 'Guadalajara', es: 'Guadalajara' }, drive: '35–45 min NE', time: '09:30',
        desc: { en: 'Drive through the gated American-style community while it is still cool. Kid at the Pumptrack Park, grown-ups check plot sizes and shade. Keep it light — full tour another day if needed.', es: 'Pasar por la urbanización americana cerrada mientras hace fresco. La peque en el Pumptrack Park, los mayores miran parcelas y sombra. Ir ligero — visita más completa otro día si hace falta.' },
        tags: ['town', 'kids', 'booking'], booking: { en: 'No booking; drive-through only today', es: 'Sin cita hoy; solo pasar y ver' },
      ...
      { icon: '🏢', kind: { en: 'Condo scouting · morning', es: 'Ver pisos · mañana' }, title: { en: 'Valdeluz', es: 'Valdeluz' }, place: { en: 'Guadalajara', es: 'Guadalajara' }, drive: '15 min toward Torremocha', time: '12:00',
        desc: { en: 'Quick drive-through before lunch: under €300k, over 110 m², 3–4 bedrooms and at least 2 bathrooms. Kid can stretch at the lake viewpoint / sports area while adults take a fast look.', es: 'Vistazo rápido antes de comer: menos de 300.000 €, más de 110 m², 3–4 dormitorios y al menos 2 baños. La peque puede estirar las piernas en el mirador del lago / zona deportiva mientras los mayores echan un vistazo.' },
        tags: ['town', 'kids'], links: [{ label: { en: 'Idealista · condos', es: 'Idealista · pisos' }, type: 'web', url: 'https://www.idealista.com/geo/venta-viviendas/valdeluz/' }, { label: { en: '🏢 €239.9k · 165m² · 3bed · 2bath', es: '🏢 239,9k€ · 165m² · 3 dorm · 2 baños' }, type: 'web', url: 'https://www.idealista.com/inmueble/111845875/' }, { label: { en: 'Lake viewpoint', es: 'Mirador del Lago' }, type: 'map', url: maps('Mirador del Lago Valdeluz Yebes Guadalajara') }, { label: { en: 'Sports centre', es: 'Centro deportivo' }, type: 'map', url: maps('Centro Deportivo Municipal Valdeluz Yebes') }] },
      { icon: '🍽️', kind: { en: 'Lunch', es: 'Comida' }, title: { en: 'Lunch in Valdeluz / Yebes area', es: 'Comida en Valdeluz / Yebes' }, place: { en: 'Valdeluz / Yebes area', es: 'Zona de Valdeluz / Yebes' }, time: '13:30',
        desc: { en: 'Simple family lunch and a rest before the afternoon visit to grandma.', es: 'Comida familiar sencilla y descanso antes de la visita a la abuela por la tarde.' },
        tags: ['food', 'kids', 'seniors'], links: [{ label: { en: 'Restaurants nearby', es: 'Restaurantes cercanos' }, type: 'food', url: maps('restaurantes Valdeluz Yebes Guadalajara') }] },
      { icon: '👵', kind: { en: 'Evening visit · final stop', es: 'Visita de tarde · última parada' }, title: { en: 'Torremocha del Jarama — grandma', es: 'Torremocha del Jarama — la abuela' }, place: { en: 'Madrid (A-1)', es: 'Madrid (A-1)' }, drive: '40–50 min toward Torremocha', time: '18:00',
        desc: { en: 'Visit grandma in the late afternoon / evening. Relaxed time: coffee, village stroll, photos, kid time with great-grandma. Last stop before driving home.', es: 'Visitar a la abuela por la tarde-noche. Tiempo tranquilo: café, paseo por el pueblo, fotos, tiempo de la peque con la bisabuela. Última parada antes de volver a casa.' },
        tags: ['friends', 'seniors', 'kids'], links: [{ label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Torremocha del Jarama Madrid') }] },
    ],
  },
  {
    id: 'aug06', dow: { en: 'Thu', es: 'Jue' }, label: 'Aug 6', emoji: '🌲',
    title: { en: 'SIERRA compare — Canexel + Los Ángeles', es: 'SIERRA comparar — Canexel + Los Ángeles' },
    corridor: { en: 'NW sierra (A-6)', es: 'Sierra NO (A-6)' },
    heat: 'cooler', tags: ['showroom', 'town', 'nature', 'food', 'booking', 'kids'],
    summary: {
      en: 'Visit the full-size wood construction in Guadarrama, then use the same A-6 outing to scout Los Ángeles de San Rafael.',
      es: 'Visitar la construcción de madera a tamaño completo en Guadarrama y aprovechar la misma salida por la A-6 para ver Los Ángeles de San Rafael.' },
    stops: [
      { icon: '🌲', kind: { en: 'Pilot house · wood', es: 'Casa piloto · madera' }, title: { en: 'Canexel — 450 m² pilot chalet', es: 'Canexel — chalet piloto de 450 m²' }, place: { en: 'Guadarrama (C/ Valle del Alberche 20E)', es: 'Guadarrama (C/ Valle del Alberche 20E)' }, drive: '~40 min',
      ...
      { icon: '📍', kind: { en: 'Residential scouting · afternoon', es: 'Scouting residencial · tarde' }, title: { en: 'Los Ángeles de San Rafael', es: 'Los Ángeles de San Rafael' }, place: { en: 'El Espinar, Segovia', es: 'El Espinar, Segovia' }, drive: '25–30 min from Guadarrama', time: '~16:00',
        desc: { en: 'Drive through the pine-forest residential areas, lake and golf surroundings. This folds the former Aug 7 stop into the A-6 day; Segovia city stays reserved for Aug 13. Proper shopping is available at Luz de Castilla, roughly 20–25 minutes away.', es: 'Recorrer las zonas residenciales entre pinares y los alrededores del lago y el golf. Así se integra la antigua parada del 7 de agosto en el día de la A-6; la ciudad de Segovia queda reservada para el 13. Hay un centro comercial completo, Luz de Castilla, aproximadamente a 20–25 minutos.' },
        tags: ['town', 'kids', 'nature'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/el-espinar-segovia/' }, { label: { en: '🏠 €299k · 134m² · 3bed · 2bath', es: '🏠 299k€ · 134m² · 3 dorm · 2 baños' }, type: 'web', url: 'https://www.idealista.com/inmueble/111789376/' }, { label: { en: '🏠 €280k · 128m² · 3bed · 2bath (new)', es: '🏠 280k€ · 128m² · 3 dorm · 2 baños (obra nueva)' }, type: 'web', url: 'https://www.idealista.com/inmueble/111643332/' }, { label: { en: 'Luz de Castilla mall', es: 'C.C. Luz de Castilla' }, type: 'web', url: 'https://www.luzdecastilla.es/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Los Angeles de San Rafael El Espinar Segovia') }] },
    ],
  },
  {
    id: 'aug07', dow: { en: 'Fri', es: 'Vie' }, label: 'Aug 7', emoji: '🏛️',
    title: { en: 'LA SAGRA value scout — Carranque + El Viso + Xanadú', es: 'LA SAGRA buscar valor — Carranque + El Viso + Xanadú' },
    corridor: { en: 'Southwest (A-5 / La Sagra)', es: 'Suroeste (A-5 / La Sagra)' },
    heat: null, tags: ['town', 'culture', 'kids', 'food'],
    summary: {
      en: 'A genuinely different corridor: Roman mosaics in Carranque, affordable low-density homes in El Viso, then a heat-safe family afternoon at the full Madrid Xanadú mall.',
      es: 'Un corredor realmente distinto: mosaicos romanos en Carranque, casas asequibles de baja densidad en El Viso y una tarde familiar a salvo del calor en el centro comercial completo Madrid Xanadú.' },
    stops: [
      { icon: '🏛️', kind: { en: 'Family culture · morning', es: 'Cultura en familia · mañana' }, title: { en: 'Carranque Archaeological Park', es: 'Parque Arqueológico de Carranque' }, place: { en: 'Carranque, Toledo', es: 'Carranque, Toledo' }, drive: '45–55 min', time: '09:30',
        desc: { en: 'Start before the heat with the Roman villa and its mosaics. Allow about two hours; the published summer schedule is Thursday–Sunday mornings.', es: 'Empezar antes del calor con la villa romana y sus mosaicos. Reservar unas dos horas; el horario de verano publicado abre de jueves a domingo por la mañana.' },
        tags: ['culture', 'kids'], links: [{ label: { en: 'Official information', es: 'Información oficial' }, type: 'web', url: 'https://cultura.castillalamancha.es/patrimonio/parques-arqueologicos/carranque' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Parque Arqueologico de Carranque Toledo') }] },
      { icon: '📍', kind: { en: 'Residential scouting', es: 'Scouting residencial' }, title: { en: 'El Viso de San Juan', es: 'El Viso de San Juan' }, place: { en: 'La Sagra, Toledo', es: 'La Sagra, Toledo' }, drive: '20–25 min', time: '~12:00',
        desc: { en: 'Scout the low-density chalet areas while checking roads, shade, utilities and internet. Current matches show substantially more house and land below €300k than the Madrid-side towns.', es: 'Recorrer las zonas de chalets de baja densidad, comprobando carreteras, sombra, suministros e internet. Las opciones actuales ofrecen bastante más casa y parcela por debajo de 300.000 € que los pueblos del lado madrileño.' },
        tags: ['town', 'kids'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/el-viso-de-san-juan-toledo/' }, { label: { en: '🏠 €240k · 180m² · 4bed · 3bath · pool', es: '🏠 240k€ · 180m² · 4 dorm · 3 baños · piscina' }, type: 'web', url: 'https://www.idealista.com/inmueble/112013394/' }, { label: { en: '🏠 €279k · 251m² · 4bed · 2bath', es: '🏠 279k€ · 251m² · 4 dorm · 2 baños' }, type: 'web', url: 'https://www.idealista.com/inmueble/111716916/' }, { label: { en: '🏠 €295k · 174m² · 4bed · 3bath · pool', es: '🏠 295k€ · 174m² · 4 dorm · 3 baños · piscina' }, type: 'web', url: 'https://www.idealista.com/inmueble/111985120/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('El Viso de San Juan Toledo') }] },
      { icon: '🍽️', kind: { en: 'Lunch', es: 'Comida' }, title: { en: 'Lunch in Carranque / El Viso', es: 'Comida en Carranque / El Viso' }, place: { en: 'La Sagra', es: 'La Sagra' }, time: '~14:00',
        desc: { en: 'A simple family lunch and rest before the indoor afternoon.', es: 'Comida familiar sencilla y descanso antes de la tarde bajo techo.' },
        tags: ['food', 'kids'], links: [{ label: { en: 'Restaurants nearby', es: 'Restaurantes cercanos' }, type: 'food', url: maps('restaurantes Carranque El Viso de San Juan') }] },
      { icon: '🛍️', kind: { en: 'Mall + family afternoon', es: 'Centro comercial + tarde familiar' }, title: { en: 'Madrid Xanadú', es: 'Madrid Xanadú' }, place: { en: 'Arroyomolinos, Madrid', es: 'Arroyomolinos, Madrid' }, drive: '~21 min from Carranque', time: '~16:00',
        desc: { en: 'A proper full mall within the 25-minute target from Carranque: shops, restaurants, cinema and indoor family activities. It also gives everyone a comfortable escape from the August heat.', es: 'Un centro comercial completo dentro del objetivo de 25 minutos desde Carranque: tiendas, restaurantes, cine y actividades familiares bajo techo. También permite escapar cómodamente del calor de agosto.' },
        tags: ['kids', 'food'], links: [{ label: { en: 'Mall website', es: 'Web del centro' }, type: 'web', url: 'https://www.xanadumadrid.com/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Madrid Xanadu Arroyomolinos') }] },
    ],
  },
  {
...
export const townsRef = [
  ...
  { name: 'Los Ángeles de San Rafael', region: { en: 'Segovia', es: 'Segovia' }, kid: { en: 'Lake surroundings + pine forest', es: 'Entorno del lago + pinar' }, day: 'Aug 6', idealista: 'https://www.idealista.com/venta-terrenos/el-espinar-segovia/', interest: { icon: '🛍️', label: { en: 'Luz de Castilla mall', es: 'C.C. Luz de Castilla' }, url: 'https://www.luzdecastilla.es/' } },
  { name: 'Carranque + El Viso de San Juan', region: { en: 'Toledo', es: 'Toledo' }, kid: { en: 'Roman mosaics + Xanadú', es: 'Mosaicos romanos + Xanadú' }, day: 'Aug 7', idealista: 'https://www.idealista.com/venta-terrenos/el-viso-de-san-juan-toledo/', interest: { icon: '🏛️', label: { en: 'Carranque archaeological park', es: 'Parque arqueológico de Carranque' }, url: 'https://cultura.castillalamancha.es/patrimonio/parques-arqueologicos/carranque' } },
...
export const bookingChecklist = [
  ...
  { id: 'b8', text: { en: 'Confirm Carranque summer opening + pack kid car entertainment (Aug 12)', es: 'Confirmar horario de verano de Carranque + entretenimiento coche peque (12 ago)' } },
]
