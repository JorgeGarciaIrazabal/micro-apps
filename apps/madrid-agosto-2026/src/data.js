  ...
  },
  {
    ...
    stops: [
      { icon: '📍', kind: { en: 'Town scouting', es: 'Ver pueblo' }, title: { en: 'Colmenar de Oreja (Urtajo)', es: 'Colmenar de Oreja (Urtajo)' }, place: { en: 'Madrid', es: 'Madrid' }, drive: '~1h',
        ...
        links: [{ label: { en: 'Urtajo map', es: 'Mapa Urtajo' }, type: 'map', url: maps('Urbanizacion Urtajo Colmenar de Oreja') }, { label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/colmenar-de-oreja-madrid/' }, { label: { en: '🏠 €209k · 237m² · 3bed', es: '🏠 209k€ · 237m² · 3 dorm' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-colmenar-de-oreja-madrid/5396093' }, { label: { en: '🏠 €299.9k · 211m² · 3bed (Balcón del Tajo)', es: '🏠 299,9k€ · 211m² · 3 dorm (Balcón del Tajo)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-colmenar-de-oreja-madrid/5251378' }, { label: { en: 'Tourism', es: 'Turismo' }, type: 'web', url: 'http://turismo.aytocdo.com/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Plaza Mayor Colmenar de Oreja') }] },
      ...
      { icon: '🏰', kind: { en: 'Optional', es: 'Opcional' }, title: { en: 'Villarejo de Salvanés — castle keep', es: 'Villarejo de Salvanés — torre del homenaje' }, place: { en: 'Madrid', es: 'Madrid' }, drive: '20–25 min',
        ...
        tags: ['town', 'kids', 'culture'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/villarejo-de-salvanes-madrid/' }, { label: { en: '🏠 €210k · 210m² · 4bed (Villarejo)', es: '🏠 210k€ · 210m² · 4 dorm (Villarejo)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/4-hab-villarejo-de-salvanes-madrid/5394572' }, { label: { en: '🏠 €179k · 179m² · 3bed (Carabaña)', es: '🏠 179k€ · 179m² · 3 dorm (Carabaña)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-carabana-madrid/5391509' }, { label: { en: 'Tourism', es: 'Turismo' }, type: 'web', url: 'https://www.turismovillarejodesalvanes.com/index.php' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Castillo Villarejo de Salvanes') }] },
    ],
  },
  {
  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '📍', kind: { en: 'Town scouting', es: 'Ver pueblo' }, title: { en: 'Nuevo Baztán / Eurovillas', es: 'Nuevo Baztán / Eurovillas' }, place: { en: 'Madrid (A-3 belt)', es: 'Madrid (corredor A-3)' }, drive: '25 min',
        ...
        links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/nuevo-baztan-madrid/' }, { label: { en: '🏠 €274k · 251m² · 4bed', es: '🏠 274k€ · 251m² · 4 dorm' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/4-hab-eurovillas-nuevo-baztan/5185421' }, { label: { en: '🏠 €245.5k · 152m² · 3bed (pueblo)', es: '🏠 245,5k€ · 152m² · 3 dorm (pueblo)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-nuevo-baztan-pueblo-nuevo-baztan/5131479' }, { label: { en: 'Town info', es: 'Info pueblo' }, type: 'web', url: 'https://turismo.ayto-nuevobaztan.es/es/servicios-y-actividades/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Eurovillas Nuevo Baztan') }] },
    ],
  },
  {
    ...
    stops: [
      ...
      { icon: '📍', kind: { en: 'Town scouting', es: 'Ver pueblo' }, title: { en: 'Galápagos / Montelar', es: 'Galápagos / Montelar' }, place: { en: 'Guadalajara', es: 'Guadalajara' }, drive: '30–40 min',
        ...
        links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/galapagos-guadalajara/' }, { label: { en: '🏠 €240k · 151m² · 3bed', es: '🏠 240k€ · 151m² · 3 dorm' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-galapagos-guadalajara/5361097' }, { label: { en: '🏠 €250k · 188m² · 3bed (indep.)', es: '🏠 250k€ · 188m² · 3 dorm (indep.)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-castilla-la-mancha-guadalajara/5310478' }, { label: { en: 'Town info', es: 'Info pueblo' }, type: 'web', url: 'https://www.galapagos.es/' }, { label: { en: 'Pumptrack', es: 'Pumptrack' }, type: 'map', url: maps('Pumptrack Park Montelar Galapagos') }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Montelar Galapagos Guadalajara') }] },
      { icon: '🏢', kind: { en: 'Condo scouting', es: 'Ver pisos' }, title: { en: 'Valdeluz', es: 'Valdeluz' }, place: { en: ' Guadalajara', es: ' Guadalajara' }, drive: '15 min toward Madrid',
        ...
        tags: ['town'], links: [{ label: { en: 'Idealista · condos', es: 'Idealista · pisos' }, type: 'web', url: 'https://www.idealista.com/geo/venta-viviendas/valdeluz/' }, { label: { en: '🏠 €257k · 170m² · 3bed (house)', es: '🏠 257k€ · 170m² · 3 dorm (casa)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-yebes-pueblo-yebes/5361165' }, { label: { en: '🏠 €187k · 168m² · 3bed (house)', es: '🏠 187k€ · 168m² · 3 dorm (casa)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-yebes-pueblo-yebes/4986221' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Valdeluz 19139 Guadalajara Spain') }] },
  ...
  },
  {
    ...
    stops: [
      { icon: '📍', kind: { en: 'Town (quick)', es: 'Pueblo (rápido)' }, title: { en: 'El Espinar / Los Ángeles de San Rafael', es: 'El Espinar / Los Ángeles de San Rafael' }, place: { en: 'Segovia', es: 'Segovia' }, drive: '45–55 min',
        ...
        tags: ['town'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/el-espinar-segovia/' }, { label: { en: '🏠 €257k · 185m² · 3bed', es: '🏠 257k€ · 185m² · 3 dorm' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-los-angeles-de-san-rafael-el-espinar/5372102' }, { label: { en: '🏠 €275k · 190m² · 3bed', es: '🏠 275k€ · 190m² · 3 dorm' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-los-angeles-de-san-rafael-el-espinar/5372112' }, { label: { en: 'Town info', es: 'Info pueblo' }, type: 'web', url: 'https://elespinar.es/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Los Angeles de San Rafael El Espinar Segovia') }] },
  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '📍', kind: { en: 'Retirement scouting', es: 'Ver pueblo' }, title: { en: 'Sotillo de la Adrada (Valle del Tiétar)', es: 'Sotillo de la Adrada (Valle del Tiétar)' }, place: { en: 'Ávila (N-403 / A-5)', es: 'Ávila (N-403 / A-5)' }, drive: '45 min S',
        ...
        tags: ['town', 'nature'], links: [{ label: { en: 'Idealista · homes', es: 'Idealista · casas' }, type: 'web', url: 'https://www.idealista.com/venta-viviendas/sotillo-de-la-adrada-avila/' }, { label: { en: '🏠 €190k · 160m² · 3bed', es: '🏠 190k€ · 160m² · 3 dorm' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-sotillo-de-la-adrada-avila/5402107' }, { label: { en: '🏠 €149.5k · 112m² · 3bed', es: '🏠 149,5k€ · 112m² · 3 dorm' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-sotillo-de-la-adrada-avila/5203683' }, { label: { en: 'Inmobiliaria', es: 'Inmobiliaria' }, type: 'web', url: 'https://grupoexcon.com/inmobiliaria/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Sotillo de la Adrada Avila') }] },
    ],
  },
  {
  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '📍', kind: { en: 'On the way home', es: 'De vuelta a casa' }, title: { en: 'Villacastín (drive-through)', es: 'Villacastín (de paso)' }, place: { en: 'Segovia (A-6)', es: 'Segovia (A-6)' }, drive: '+15 min',
        ...
        tags: ['town'], links: [{ label: { en: 'Idealista · plots', es: 'Idealista · parcelas' }, type: 'plots', url: 'https://www.idealista.com/venta-terrenos/villacastin-segovia/' }, { label: { en: '🏠 €117k · 109m² · 3bed (Ituero)', es: '🏠 117k€ · 109m² · 3 dorm (Ituero)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-ituero-y-lama-segovia/5372171' }, { label: { en: '🏠 €187k · 214m² · 3bed (Zarzuela)', es: '🏠 187k€ · 214m² · 3 dorm (Zarzuela)' }, type: 'web', url: 'https://casasenventaypisosalquiler.es/vivienda/casas-en-venta/3-hab-zarzuela-del-monte-segovia/5372017' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Villacastin Segovia') }] },
