  ...
  },
  {
    ...
    stops: [
      ...
      { icon: '🏢', kind: { en: 'Condo scouting', es: 'Ver pisos' }, title: { en: 'Valdeluz', es: 'Valdeluz' }, place: { en: ' Guadalajara', es: ' Guadalajara' }, drive: '15 min toward Madrid',
        ...
        tags: ['town'], links: [{ label: { en: 'Idealista · condos', es: 'Idealista · pisos' }, type: 'web', url: 'https://www.idealista.com/geo/venta-viviendas/valdeluz/' }, { label: { en: 'Apts · 3bed · <300k', es: 'Pisos · 3 dorm · <300k' }, type: 'web', url: 'https://www.idealista.com/geo/venta-viviendas/valdeluz/con-de-tres-dormitorios/' }, { label: { en: 'Map', es: 'Mapa' }, type: 'map', url: maps('Valdeluz 19139 Guadalajara Spain') }] },
