...
export const days = [
  ...
  },
  {
    ...
    title: { en: 'SIERRA compare — Modulartis + Canexel + Los Ángeles', es: 'SIERRA comparar — Modulartis + Canexel + Los Ángeles' },
    corridor: { en: 'NW sierra (A-6)', es: 'Sierra NO (A-6)' },
    heat: 'cooler', tags: ['showroom', 'town', 'nature', 'food', 'booking', 'kids'],
    summary: {
      en: 'Compare a finished concrete home and full-size wood construction in Guadarrama, then use the same A-6 outing to scout Los Ángeles de San Rafael.',
      es: 'Comparar una casa acabada de hormigón y construcción de madera a tamaño completo en Guadarrama, y aprovechar la misma salida por la A-6 para ver Los Ángeles de San Rafael.' },
    stops: [
